...
- балансируй стоимость triage в MVP:
  - полный рекурсивный обход ФС **разрешен**, но стандартные “тяжелые” каталоги по умолчанию не сканируй глубоко;
  - если есть подозрение/указатели (cron/unit/config), запланируй углубление в нужные подпути;
  - хеширование планируй только для исполняемых/подозрительных/из опасных директорий.
